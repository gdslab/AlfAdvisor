...
const FieldCharts = () => {
  ...
  useEffect(() => {
    ...
    const fetchWeatherData = async () => {
      ...
      setTemperature(temperature_2m.slice(- futureTimes.length));
      setRain(precipitation.slice(- futureTimes.length));
      setIsRainAbove2(precipitation.some(n => n > 0.1));
    };
  ...
  console.log('this is setdata',setIsRainAbove2)
  return (
      ...
      <div className="graphs">
        {xAxes.length > 0 && temperature.length > 0 && rain.length > 0 && (
          <>
            ...
            {isRainAbove2 && (
              <div className="notification-weather-box">
