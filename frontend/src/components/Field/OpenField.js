...
import { createColorScale, colorScale } from "./colorScale";
import MapLayersControl from './MapLayersControl';
import ProcessingComponent from './Processing_dynamic';
import DataStatisticsTable from './YQdata_statistics';
...
function OpenField(props) {
    ...
    const TiffOverlayComponent = ({ imagePath, onLoad }) => {
    ...
    const dataMin = 0;
    const dataMax = 50;
    const colorScale = createColorScale(dataMin, dataMax);
            ...
            <div className="layout-container">
                ...
                >
                    ...
                    {show && images.length > 0 && (
                        <Legend min={dataMin} max={dataMax} colorScale={colorScale} />
                    )}
                ...
                <div className="layout-box">
                    ...
                    <div className="yield-input-container">
                        ...
                        {show && !processing && (<div className="notification">Yield and quality model results are displayed in the tables below, with daily parameter statistics provided in separate tables. To visualize the results on the map, please select a map layer to update the display and/or proceed with running the economic model.</div>)}
                        {/* {show && !processing && (<DataStatisticsTable YQdata={YQdata} />)} */}
                    </div>
